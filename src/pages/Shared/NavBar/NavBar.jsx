...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        <li><ActiveLink to="/dashboard">Dashboard</ActiveLink></li>
        {
            user ? <>
                ...
                <li>
                    <ActiveLink to="/login">
                        <button className="btn btn-warning flex justify-center items-center">
                            Login
                        </button>
                    </ActiveLink>
                </li>
    ...
    return (
        <nav className="navbar bg-base-200 py-1">
            ...
            <div className="navbar-end">
                <div className="dropdown z-10">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-6 -ml-40 p-2 shadow bg-base-100 rounded-box w-52 items-end space-y-2 bg-base-200">
                        {navItems}
                    </ul>
                </div>
                <ul className="menu menu-horizontal  hidden lg:flex justify-center items-center px-1">
                    {navItems}
                </ul>
            </div>
        </nav>
