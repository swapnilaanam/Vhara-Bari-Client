...
const Services = () => {
    return (
        <div className="py-28 bg-green-50">
            <h2 className="text-3xl font-medium text-center uppercase tracking-wider">Why Choose Us?</h2>
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center lg:items-end gap-16 lg:gap-28 pt-14 text-center">
                <div className="w-80">
                    <Lottie animationData={service1Animation} className="h-60" />
